...
let addLinkUp = document.getElementsByClassName("addLinkUp");
let addLinkUpModal = document.querySelector(".bg-modal");
let addLinkDown = document.getElementsByClassName("addLinkDown");
...
bannersShow.addEventListener("load", function() {
...
addLinkUp[0].addEventListener("click", function() {
  addLinkUpModal.style.display = "flex";
  update();
});
addLinkDown[0].addEventListener("click", function() {
  // add link down
  update();
});
